...
spellbook-voidapplause-desc = Поменяйтесь местами с целью, разве это не заставляет вас танцевать от радости?
...
spellbook-repulse-desc = Скажите людям ПРОЧЬ С ДОРОГИ и оттолкните их от себя.
spellbook-smoke-name = Дым
spellbook-smoke-desc = Вызывает облако дыма, довольно очевидно.
...
spellbook-smite-desc = Не нравится кто-то? ВЗОРВИТЕ его на куски! Требуется мантия и шляпа волшебника.
spellbook-cluwne-name = Проклятие клувна
spellbook-cluwne-desc = Для случаев, когда вы действительно ненавидите кого-то, и кары недостаточно. Требуется мантия и шляпа волшебника.
spellbook-slip-name = Скользкий путь
spellbook-slip-desc = Изучите древние пути уборщика и прокляните свою цель на скольжение. Требуется мантия и шляпа волшебника.
spellbook-item-recall-name = Призыв предмета
spellbook-item-recall-description = Отметьте удерживаемый предмет и призовите его обратно в любой момент простым щелчком пальцев!
...
spellbook-hammer-mjollnir-description = Владейте силой ГРОМА в своих руках. Отправляйте врагов в полёт мощным взмахом или метая молот прямо в них!
spellbook-hammer-singularity-name = Молот сингулярности
spellbook-hammer-singularity-description = Интересно, каково это — быть сингулярностью? Взмахните этим молотом, чтобы притянуть окружение, работает даже если вы промахнётесь!
