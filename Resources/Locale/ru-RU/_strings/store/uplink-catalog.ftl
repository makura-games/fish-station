...
uplink-mosin-ammo-name = Коробка патронов (7,62к)
uplink-mosin-ammo-desc = Коробка с 20 патронами 7,62х54ммR для винтовки или среднего пулемета.
uplink-sniper-ammo-name = Коробка патронов (15мм антиматериальные)
uplink-sniper-ammo-desc = Коробка с 14 патронами для снайперской винтовки Христов или SR-127.
# Utility
...
uplink-ammo-bundle-desc = Перезаряжаю! Содержит 4 магазина для c20r, 4 магазина для Бульдога, 4 магазина для Эсток и 2 патронных короба для L6 SAW.
...
uplink-c20r-bundle-desc = Старый добрый C-20r в комплекте с 14 магазинами разных типов.
uplink-bulldog-bundle-name = Набор "Бульдог"
uplink-bulldog-bundle-desc = Простой и надёжный: содержит дробовик «Бульдог», термальный визор и 9 барабанов разных типов.
uplink-estoc-bundle-name = Набор «Эсток»
uplink-estoc-bundle-desc = Марксманская винтовка «Эсток» с оптикой средней дальности и 14 магазинов разных типов (5,56 мм).
...
uplink-l6-saw-bundle-desc = Ещё больше дакки: культовый лёгкий пулемёт L6 SAW в комплекте с 3 коробами патронов по 200 патронов каждый. Штурмовая версия, что совершенно не сковывает движение, ценой точности.
...
uplink-hardsuit-syndieelite-desc = Модифицированная версия кроваво-красного скафандра, в которой часть баллистической защиты принесена в жертву высокой устойчивости к взрывам, энергетическому оружию и самым суровым атмосферным условиям. Используется истинной элитой.
uplink-clothing-outer-hardsuit-juggernaut-name = Скафандр джаггернаута Cybersun
uplink-clothing-outer-hardsuit-juggernaut-desc = Сверхпрочная броня из материалов, испытанных в хромосферном комплексе Тау. Единственное, что сможет вас замедлить, — этот костюм... и станнеры.
# Misc
...
uplink-travel-camera-desc = Оглушайте людей своими фотографическими навыками и совершенно легальной вспышкой камеры. Выглядит так, будто вы турист.
...
uplink-syndicate-pai-desc = пИИ Синдиката с каналом Синдиката и встроенным магазином модулей (15 памяти). Боевая медицина, автодозатор, взлом дверей, мониторинг экипажа, камеры и вспомогательные инструменты.
...
uplink-hijack-beacon-desc = Маяк захвата производства Синдиката, предназначенный для обхода межсетевых экранов автоматизированных торговых станций производства Nanotrasen. Для работы им требуется 200 секунд, а торговые станции объявят о попытке взлома, так что подготовьтесь заранее.
