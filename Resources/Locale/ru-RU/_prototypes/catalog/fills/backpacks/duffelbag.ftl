...
ent-ClothingBackpackDuffelSyndicateFilledVectorSuper = набор «Вектор Супер»
    .desc = Классический пистолет-пулемёт «Вектор Супер» в комплекте с двенадцатью магазинами разных типов.
