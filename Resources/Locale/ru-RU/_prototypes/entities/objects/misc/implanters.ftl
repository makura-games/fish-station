...
ent-ImplanterExtractor = экстрактор имплантов
    .desc = Специализированный шприц, предназначенный для извлечения подкожных имплантов. Выберите режим извлечения и используйте устройство на цели, чтобы начать процедуру. Извлечённые импланты хранятся внутри устройства до их ручного извлечения.
