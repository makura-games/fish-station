...
// Расширенная панель ручного анализатора не заменяет стандартную панель криокапсулы.

[GenerateTypedNameReferences]
public sealed partial class FishHealthAnalyzerControl : BoxContainer
{
    ...
    private void DrawReagents()
    {
        ...
        foreach (var (id, quantity) in _medicationAmounts)
        {
            if (_prototypes.TryIndex(id, out var prototype))
                entries.Add((prototype, quantity));
        }
